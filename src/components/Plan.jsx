    ...
    <div className="max-w-[1400px] m-auto py-16 px-4 grid lg:grid-cols-2 gap-4">
      ...
      <div className="flex flex-col h-full justify-center">
        ...
        <p className="text-2xl py-6">
          ...
          dolorum quos natus temporibus mollitia repellat magnam, consequuntur
          minus consequatur necessitatibus nam dignissimos odio, iusto nisi?
          Adipisci ea fugit sed.
        </p>
        <p className="pb-6">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Amet vel
          dolorum quos natus temporibus mollitia repellat magnam, consequuntur
